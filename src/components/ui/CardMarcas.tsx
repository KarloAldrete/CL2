...
/*     <div className='flex flex-col gap-2 justify-center items-center w-full min-h-full '>
      <div className={`bg-[#16191D] flex justify-center items-center rounded-lg w-full max-w-[385px] h-[164px] bg-[url(/images/${image})] bg-no-repeat bg-center sm:max-w-[280px]`} />
